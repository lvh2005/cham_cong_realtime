...
FACE_MATCH_THRESHOLD = _get_float_env("FACE_MATCH_THRESHOLD", 0.48)
FACE_DUPLICATE_THRESHOLD = _get_float_env("FACE_DUPLICATE_THRESHOLD", 0.40)
FACE_AMBIGUOUS_MARGIN = _get_float_env("FACE_AMBIGUOUS_MARGIN", 0.06)
